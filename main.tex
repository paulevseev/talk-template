    ...
    \begin{columns}
      ...
      \column[c]{0.55\textwidth}
        \begin{block}{Configuration – sandwiched structure}
          ...
          \end{itemize}
          \begin{center}
            \includegraphics[width=2.5cm]{mode_profile.png}
          \end{center}
        \end{block}
    \end{columns}
  \end{frame}
  
  \begin{frame}{Motivation – the challenge}
...
%------------------------------
  ...
  \begin{frame}{Experimental techniques}
               {We have a series of images on this slide}
    \begin{block}{The block is 65 mm in height}
      \begin{center}
        \vbox to 65mm{
        \only<1>{\includegraphics[width=0.95\textwidth]{setup1.pdf}}
        \only<2>{\includegraphics[width=0.95\textwidth]{setup2.pdf}}
        \only<3>{\includegraphics[width=0.95\textwidth]{setup3.pdf}}
      \end{center}
    \end{block}
  \transdissolve<2>
  \transwipe<3>

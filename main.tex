...
%------------------------------
  ...
  \begin{frame}{Concept of BER penalty}
    ...
    \end{block}
    \begin{center}
      \includegraphics[width=0.4\linewidth]{BER_penalties.pdf}
    \end{center}
  \end{frame}
  ...
  \begin{frame}{Experimental techniques}
    \begin{block}{Prototype of fiber optic communication system}
      \begin{center}
        \vbox to 65mm{
        \only<1>{\includegraphics[width=0.95\textwidth]{BERsetup1.pdf}}
        \only<2>{\includegraphics[width=0.95\textwidth]{BERsetup2.pdf}}
        \only<3>{\includegraphics[width=0.95\textwidth]{BERsetup3.pdf}}
        \only<4>{\includegraphics[width=0.95\textwidth]{BERsetup3.pdf}\\
                 \vspace{-20mm}\hspace{35mm}\includegraphics[width=0.55\textwidth]{Pbudget.pdf}}}
      \end{center}
    \end{block}
  \transdissolve<2>
  \transwipe<3>
  ...
  \begin{frame}{Results and Contribution}
    ...
    \begin{block}{1541\,–\,1556\,nm, channel spacing 0.4\,nm}
      ...
      \vbox to 58mm{
          ...
          \begin{itemize}
            \item WG – waveguide
            \item B2B – back-to-back\\\hfil(reference)~~~
          \end{itemize}
        \end{columns}
    \end{block}
  \end{frame}
...
%-----------------
  \begin{frame}{Summary}
    ...
    \item[\cmark] BER penalties are less than 6\,dB (about 4 times) over the 15\,nm range
%    \item[\xmark] Most losses are caused by imperfect coupling
    ...
    \begin{center}
      \includegraphics[width=0.5\textwidth]{coupling_alignment_VIS-crop.jpg}
    \end{center}

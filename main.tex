...
%---------------------------------
  \begin{frame}{Results and Contribution}
    ...
    \begin{block}{1541\,–\,1556\,nm, channel spacing 0.4\,nm}
      \centering
      \only<1>{\includegraphics[height=62mm]{Penalties_double_channel_fixed_spacing_different_wavelength.pdf}}
      \only<2>{\includegraphics[height=62mm]{spectrum1.pdf}}
      \only<3>{\includegraphics[height=62mm]{spectrum2.pdf}}
      \only<4>{\includegraphics[height=62mm]{spectrum3.pdf}}
      \only<5>{\includegraphics[height=62mm]{Penalties_double_channel_fixed_spacing_different_wavelength.pdf}}
    \end{block}
  \end{frame}

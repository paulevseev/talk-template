...
%----------------------
  ...
  \begin{frame}<presentation>{Abstract}
    \begin{itemize}
      \item We demonstrate 10\,Gbit/s transmission over\\
            300\,$\mu$m-long nanooptic waveguide
            \vspace{3mm}
      \item The signal degradation is almost negligible\cite{kharitonov_data_2014}
    \end{itemize}
  \end{frame}
...
%------------------------------
  ...
  \begin{frame}{Concept of BER penalty}
    \begin{block}{Difference between DUT and ideal attenuator in terms of BER}
      \begin{center}
        \only<1>{\vbox to 3cm{\vfil
                 \includegraphics[width=0.55\textwidth]{sig_and_noise.pdf}
                 \vfil}}
        \only<2>{\vbox to 3cm{\vfil
                 \includegraphics[width=0.7\textwidth]{BER_impairment.pdf}\vfil}}
      \end{center}
    \end{block}
    \begin{center}
     \includegraphics[width=0.65\linewidth]{BER_penalties.pdf}
    \end{center}

    Eye diagram (left) is the overlay of all possible transitions
    \begin{center}
      \includegraphics[width=0.9\textwidth]{hist_processing_diagram.pdf}
    \end{center}
  \end{frame}
  ...
  \begin{frame}{Concept of Penalties}
    ...
    \begin{center}
     \includegraphics[width=0.8\linewidth]{BER_impairment.pdf}
    \end{center}
    \begin{center}
     \includegraphics[width=0.8\linewidth]{BER_penalties.pdf}
    \end{center}
  \end{frame}
  ...
  \begin{frame}{Measurement techniques}
   \begin{center}
    \includegraphics[width=0.9\textwidth]{BERsetup.pdf}
   \end{center}
  ...
  \begin{frame}{Data processing techniques}
    \begin{columns}
      ...
      \column[T]{0.55\textwidth}
        \includegraphics[width=\textwidth]{sig_and_noise.pdf}
    \end{columns}
    Eye diagram (left) is the overlay of all possible transitions
    \begin{center}
      \includegraphics[width=0.9\textwidth]{hist_processing_diagram.pdf}
